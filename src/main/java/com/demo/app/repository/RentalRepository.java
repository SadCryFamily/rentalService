...
public interface RentalRepository extends JpaRepository<Rental, Long> {
    ...
    Optional<Rental> findByCustomerIdAndRentalId(@Param("cid") Long cid, @Param("rid") Long rid);

    @Query(value = "SELECT r.rental_id, r.photo_url, r.rental_name, r.rental_city, r.rental_address,r.rental_description, r.rental_area, r.rental_price, r.rental_created_at, r.rental_updated_at, r.is_deleted " +
            "FROM rental AS r " +
